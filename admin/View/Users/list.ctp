<?php $this->assign('title', 'Intellex | ユーザー一覧'); ?>
        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">登録日 </label>
                        <div class="col-sm-7 form-inline">
                    ...
                    <table class="table table-striped table-bordered responsive">
                        ...
                        <?php foreach($users as $user): ?>
                            <tr>
                                ...
                                <td class="center"><?php echo $this->Html->link($user['User']['full_name'], '/users/' . $user['User']['id']);?></td>
                                <td class="center"><?php echo $user['User']['full_name_kana'];?></td>
                                <td class="center"><?php echo $this->User->getSexLabelByCode($user['User']['sex']);?></td>
                                <td class="center"><?php echo $this->User->calculateAge($user['User']['birthday']);?></td>
                                <td class="center"><?php echo $this->User->dateTimeToString($user['User']['created']);?></td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
                    </table>
