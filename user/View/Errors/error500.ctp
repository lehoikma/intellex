<?php $this->assign('title', '500 INTERNAL SERVER ERROR | アセットシェアリング') ?>
...
<div class="contents"><div class="contentsCont">
    <h2 class="title404">500 INTERNAL SERVER ERROR<br>内部エラーが発生しています</h2>
    <p class="button404"><?php echo $this->Html->link('トップページに戻る', '/', array('class' => 'buttonStyle01'))?></p>
</div></div>
